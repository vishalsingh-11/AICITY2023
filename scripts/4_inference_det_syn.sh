...
python3 tools/aic_get_detection_syn.py configs/custom_dataset/yolov7_base.py work_dirs/yolov7_market/yolov7_x_syncbn_fast_8x16b-300e_coco_20221124_215331-ef949a68.pth --scene S005 --out-dir ../data/
